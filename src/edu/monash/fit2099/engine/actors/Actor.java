...
public abstract class Actor extends GameEntity implements Printable {
    ...
    /**
     * Status effects of the current actor,
     * e.g., the current actor might be poisoned, so a Poison status effect
     * can be attached to the current actor to deal damage over time.
     */
    ...
    /**
     * Attach a status effect to the current actor
     *
     * @param effect effect to be attached to the current actor
     */
    ...
    /**
     * Remove a status effect from the current actor
     *
     * @param effect effect to be removed from the current actor
     */
    ...
    /**
     * Get a copy of this actor's status effect list.
     * Although it is possible to return the status effect list to be modified by the client directly,
     * it is not done as to prevent privacy leak.
     *
     * @return An unmodifiable wrapper of the actor's status effect list.
     */
     ...
     *
     * @param intrinsicWeapon the intrinsic weapon of an actor, e.g. claw, bare fist, etc.
     */
